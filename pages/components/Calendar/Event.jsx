...
const Event = ({ eventInfo }) => {
    ...
    return (
        <div className="flex bg-gray-800 text-white rounded-lg max-w-lg min-h-[100px] text-left p-3">
            <div className="w-2/3">
                {/* Title of the event */}
            ...
            <div className="w-1/3 text-center">
                <div className="flex flex-col text-sm m-2">
                    ...
                    <p>{eventEndTime}</p>
                    {eventInfo.url ? (
                        <a href={eventInfo.url} className="p-2 font-semibold rounded-md self-center bg-blue-600 no-underline text-white">
                            Reservation Form
                        </a>
                    ) : (
                        <div href={eventInfo.url} className="p-2 font-semibold rounded-md self-center bg-blue-600 no-underline text-white">

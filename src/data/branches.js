export const branches = {
    ...
    Web: {
        name: 'Web',
        about: 'The Web Branch consists of officers tasked with web management for AIAA UTD. They specialize in user experience design, front-end development, and back-end development to create a website for the organization. This branch is led by the Web Director and includes all Web Developers.',
        cover: '',
        images: '',
    },
}
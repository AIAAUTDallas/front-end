        ...
        <div className="min-h-[95svh] bg-[#0f172a]">
            ...
            <div className="h-[90svh] bg-[url(https://images4.alphacoders.com/820/820238.jpg)] bg-no-repeat bg-cover">
                ...
                <div className="flex flex-col justify-center items-center h-[90vh]">
                    <h1 className="text-4xl md:text-6xl text-white font-bold uppercase">Test</h1>
            ...
            <Section className="flex flex-col">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:p-4 flex-grow items-center mt-4">
                    <div className="bg-[#0f172a] md:p-4">
                        ...
                        <p className="text-base md:text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Beatae, exercitationem. Ducimus iure repellat harum repellendus veritatis ratione. Ullam, tempore iste!</p>
                    </div>
                    <div className="bg-[#0f172a] md:p-4">
            ...
            <Section className="flex flex-col" style={{
                ...
                <h1 className="uppercase text-center text-3xl md:text-4xl">Special Section (whatever you all want here maybe)</h1>
            </Section>

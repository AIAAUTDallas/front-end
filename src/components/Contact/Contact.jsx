    ...
    <section class="bg-slate-900 dark:bg-gray-900">
      ...
      <h1 class="text-3xl font-bold text-center">
        ...
        <form action="#" class="space-y-8">
          ...
          <button
            type="submit"
            class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-black-900 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-black-900 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
          >
            Send message
          </button>
        </form>
